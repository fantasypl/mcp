...
// `fplctl gengolden` regenerates them from the frozen FPL payloads in
// testdata/ and should reproduce them exactly — `fplctl gengolden --check`
// verifies that. Refresh them only when the expected behavior changes
// intentionally.
package golden
...
// tighter than anything meaningful while absorbing ordinary floating-point
